...
const theme = (darkMode, color) => ({
  ...
  backgroundColor: darkMode ? '#1f2126' : '#F7F8FA',

  uniswapPink: darkMode ? '#f04c61' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#f04c61',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#f04c61',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#f04c61',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #f04c6130 0%, #fff 0%)`,
})
